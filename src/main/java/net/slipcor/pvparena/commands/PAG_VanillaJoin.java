...
/**
 * <pre>PVP Arena VANILLAJOIN Command class</pre>
 * <p/>
...
public class PAG_VanillaJoin extends AbstractGlobalCommand {
    ...
    public List<String> getMain() {
        return Collections.singletonList(VANILLAJOIN);
    }

    @Override
    public List<String> getShort() {
        return Collections.singletonList(VANILLAJOIN_SHORT);
    }
